...
This research looks at steps collected by personal activity monitoring device.  This device collects data at 5
...
This research is a result of participation in John Hopkins Reproducible Peer Assessment 1 assignment organized by
...
Maximum average number of steps = `r maxInterval$steps`


##Analysis by Date with Missing Value Replace
...
*Histogram looks more 'normalize' however the mean is not affected by the median becomes the same as the mean


## Comparison by Weekend vs. Weekday
